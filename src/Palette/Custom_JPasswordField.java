...
public class Custom_JPasswordField extends JPasswordField implements Serializable {
    ...
    // Properti warna, border, dan placeholder
    ...
    protected void paintComponent(Graphics g) {
        ...
        // Render inputan password asli (bintang/bulatan) di atas background
        super.paintComponent(g); 

        // 2. Gambar Placeholder jika password field masih kosong
        // Menggunakan getPassword().length untuk mengecek array char-nya kosong atau tidak
        if (getPassword().length == 0 && placeholder != null) {
            ...
            int x = insets.left;
            int y = (height - fontHeight) / 2 + fontHeight; // Vertikal center
