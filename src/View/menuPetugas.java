...
public class menuPetugas extends javax.swing.JPanel {
    ...
    if (baris != -1) {
        // Mengambil data dari tabel sesuai urutan kolom
        String idAdmin  = jTable1.getValueAt(baris, 1).toString();
        ...
        String level    = jTable1.getValueAt(baris, 5).toString();
        
        // Pindah ke panel CRUD dengan membawa data
        MenuUtama menuUtama = (MenuUtama) javax.swing.SwingUtilities.getWindowAncestor(this);
        if (menuUtama != null) {
            menuUtama.showPanel(new menuCRUDPetugas(idAdmin, nama, username, email, level));
        }
    } else {
        javax.swing.JOptionPane.showMessageDialog(this, "Pilih data petugas di tabel terlebih dahulu!");
    }
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        panelTambah.setVisible(false);// TODO add your handling code here:
